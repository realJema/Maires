  ...
  <script src="js/datatables/tools/js/dataTables.tableTools.js"></script> -->
        ...
        <script>
          ...
          function filter(e='none') {
            ...
            // add map id if it is not none
            if(map != 'none') {
              alert(typeof map);
              searchTerms.push(map);
            }

            $('#filter_table select').filter(
              function(){
                // add every select value which is not All
                if($(this).val()!="All"){
                  searchTerms.push($(this).attr('id'));
                }
              });

            // alert(typeof searchTerms);
            if(typeof eval(searchTerms[3]) != 'undefined'){
              table.search(eval(searchTerms[0]) + ' ' + eval(searchTerms[1]) + ' ' + eval(searchTerms[2]) + ' ' + eval(searchTerms[3])).draw();
            }
            else if(typeof eval(searchTerms[2]) != 'undefined'){
