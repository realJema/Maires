...
<body class="nav-md">
  ...
  <script src="js/datatables/tools/js/dataTables.tableTools.js"></script> -->
        ...
        <script src="js/datatables/buttgitons.print.min.js"></script>
